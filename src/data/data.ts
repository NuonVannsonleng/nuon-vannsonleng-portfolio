...
export const socialLinks: SocialLink[] = [
  ...
  { label: 'Facebook', url: 'https://www.facebook.com/jay.lhwa', icon: 'facebook' },
  { label: 'Instagram', url: 'https://www.instagram.com/j.lhwa/', icon: 'instagram' },
  { label: 'Telegram', url: 'https://t.me/j_lhwa', icon: 'telegram' },
